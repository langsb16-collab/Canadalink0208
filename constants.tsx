...
export const MOCK_MARKETPLACE: CommunityPost[] = [
  { id: 'm1', title: 'IKEA 3단 서랍장', price: '$40', city: 'Toronto', description: '상태 깨끗합니다. 노스욕 픽업.', lat: 43.7615, lng: -79.4111, createdAt: '2h ago', image: 'https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=300&q=80' },
  { id: 'm2', title: '2019 혼다 시빅', price: '$18,000', city: 'Vancouver', description: '무사고, 6만km 주행.', lat: 49.2827, lng: -123.1207, createdAt: '5h ago', image: 'https://images.unsplash.com/photo-1517672651691-24622a91b550?auto=format&fit=crop&w=300&q=80' },
];

export const MOCK_JOBS: CommunityPost[] = [
  { id: 'j1', title: '한식당 주방 보조 구합니다', price: '$17/hr', city: 'Toronto', description: '초보 가능, 파트타임.', lat: 43.6532, lng: -79.3832, createdAt: '1h ago', type: 'Hiring' },
  { id: 'j2', title: '그래픽 디자이너 구직중', price: 'Negotiable', city: 'Calgary', description: '경력 5년, 포트폴리오 유.', lat: 51.0447, lng: -114.0719, createdAt: '3h ago', type: 'Seeking' },
];

export const MOCK_REALESTATE: CommunityPost[] = [
  { id: 'r1', title: '노스욕 1베드 콘도 렌트', price: '$2,400/mo', city: 'Toronto', description: '지하철역 도보 5분.', lat: 43.7615, lng: -79.4111, createdAt: '10m ago', image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=300&q=80' },
  { id: 'r2', title: '코퀴틀람 하우스 룸쉐어', price: '$900/mo', city: 'Vancouver', description: '즉시 입주 가능.', lat: 49.2838, lng: -122.7932, createdAt: '1h ago', image: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=300&q=80' },
];

export const MOCK_FRIENDS: CommunityPost[] = [
  { id: 'f1', title: '주말 축구 모임 모집', city: 'Toronto', description: '실력 상관없이 즐겁게 차실 분.', lat: 43.6532, lng: -79.3832, createdAt: '4h ago', category: 'Sports' },
  { id: 'f2', title: '육아 정보 공유해요', city: 'Oakville', description: '근처 사시는 맘들 소통해요.', lat: 43.4675, lng: -79.6877, createdAt: '6h ago', category: 'Parenting' },
];

export const MOCK_PROMO: CommunityPost[] = [
  { id: 'p1', title: '새로 오픈한 일식당 특가!', city: 'Toronto', description: '오픈 기념 전메뉴 20% 할인.', lat: 43.6532, lng: -79.3832, createdAt: '12h ago', image: 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=300&q=80' },
  { id: 'p2', title: '유학원 무료 상담 서비스', city: 'Vancouver', description: '전문 컨설턴트 1:1 상담.', lat: 49.2827, lng: -123.1207, createdAt: '1d ago' },
];
