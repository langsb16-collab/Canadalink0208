...
export const translations: Record<string, any> = {
  ko: {
    brand: "K-Link",
    slogan: "Linking Koreans Everywhere",
    dashboard: "대시보드",
    settlement: "정착 정보",
    business: "비즈니스",
    policy: "정책 참여",
    ...
    search: "통합 검색...",
    welcome: "환영합니다",
    platformStatus: "K-Link 보안 네트워크 작동 중",
    auth: {
      guest: "게스트 모드",
      anonymous: "익명 게스트",
      auth_needed: "인증 필요",
    ...
    dash: {
      ...
      business_transactions: "비즈니스 거래",
      policy_engagement: "정책 참여도",
      from_last_month: "지난달 대비",
      network_title: "커뮤니티 연결 네트워크",
      ai_report: "K-Link AI 분석 보고서",
      ai_loading: "보고서 생성 중...",
      active_links: "활성 연결",
      growth_trend: "커뮤니티 성장 트렌드"
    },
    network: {
      settings_title: "네트워크 인텔리전스",
      visualize: "연결선 표시",
      visualize_desc: "사용자 간의 상호작용 연결망을 시각화합니다.",
      highlight: "활발한 노드 강조",
      highlight_desc: "커뮤니티 활동이 많은 참여자를 강조 표시합니다.",
      recent: "최근 연결만",
      recent_desc: "최근 30일 이내의 활발한 연결만 필터링합니다.",
      save: "설정 저장"
    }
  },
  en: {
    ...
    search: "Search...",
    welcome: "Welcome",
    platformStatus: "K-Link Secure Network Active",
    auth: {
      guest: "Guest Mode",
    ...
    dash: {
      ...
      policy_engagement: "Policy Engagement",
      from_last_month: "from last month",
      network_title: "Community Connection Network",
      ai_report: "K-Link AI Report",
      ai_loading: "Generating report...",
      active_links: "Active Links",
      growth_trend: "Community Growth Trend"
    },
    network: {
      settings_title: "Network Intelligence",
      visualize: "Visualize Connections",
      visualize_desc: "Display lines between interacting community members.",
      highlight: "Highlight Active Nodes",
      highlight_desc: "Apply visual emphasis to high-frequency network participants.",
      recent: "Recent Links Only",
      recent_desc: "Filter network to show only connections made within 30 days.",
      save: "Save Config"
    }
  },
  zh: { 
    brand: "K-Link", slogan: "Linking Koreans Everywhere", dashboard: "仪表板", settlement: "定居", business: "业务", policy: "政策", support: "支持", admin: "管理", infra: "基础设施", translation: "翻译",
    auth: { guest: "游客模式", anonymous: "匿名游客", auth_needed: "需要认证", verified: "已认证", my_account: "我的账户", verify_id: "身份认证" },
    dash: { analytics_title: "K-Link 数据分析", analytics_desc: "实时社区网络和经济指标。", live_network: "实时网络", total_members: "总会员数", community_success: "社区成功率", business_transactions: "商业交易", policy_engagement: "政策参与度", from_last_month: "较上月", network_title: "社区连接网络", ai_report: "K-Link AI 报告", ai_loading: "生成报告中...", active_links: "活动连接", growth_trend: "社区增长趋势" },
    network: { settings_title: "网络智能", visualize: "可视化连接", visualize_desc: "显示社区成员之间的互动线。", highlight: "突出显示活动节点", highlight_desc: "对高频网络参与者应用视觉强调。", recent: "仅限最近链接", recent_desc: "过滤网络以仅显示 30 天内建立的连接。", save: "保存配置" }
  },
  ja: { 
